...
export { default as LoadedImg } from '../..\\components\\LoadedImg.vue'
...
export const LazyLoadedImg = import('../..\\components\\LoadedImg.vue' /* webpackChunkName: "components/loaded-img" */).then(c => wrapFunctional(c.default || c))
