...
$lastModified=filemtime('./header.php'); 
...
function add_this_script_footer(){
   //Swipper Js
   wp_register_script('swipper-js', get_stylesheet_directory_uri() . '/src/assets/js/swiper.js');
   wp_enqueue_script('swipper-js');
   wp_register_script('aos', get_stylesheet_directory_uri() . '/src/assets/js/swiper.js');
   wp_enqueue_script('aos');
   //uncompiled Script 
   wp_register_script('vue', get_stylesheet_directory_uri() . '/src/assets/js/content.vue.js');
   wp_enqueue_script('vue');
   
  wp_register_script('script-js', get_stylesheet_directory_uri() . '/src/assets/js/script.js');
